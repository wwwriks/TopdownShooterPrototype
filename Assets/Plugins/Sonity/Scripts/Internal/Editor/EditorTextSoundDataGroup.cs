...
namespace Sonity.Internal {
    ...
    public class EditorTextSoundDataGroup {
        ...
        public static string soundDataGroupTooltip =
            ...
            "\n" +
            $"All {nameof(NameOf.SoundDataGroup)} objects are multi-object editable." + NameOf.Tooltip;

        public static string childSoundDataGroupsLabel = $"Child {nameof(NameOf.SoundDataGroup)}s";
        public static string childSoundDataGroupsTooltip = $"Nesting {nameof(NameOf.SoundDataGroup)}s makes it easy to load/unload all audio data or just parts of it." + NameOf.Tooltip;

        public static string soundEventsLabel = $"{nameof(NameOf.SoundEvent)}s";
        public static string soundEventsTooltip = $"The {nameof(NameOf.SoundEvent)} whoms audio data will be loaded or unloaded." + NameOf.Tooltip;
    }
}
#endif