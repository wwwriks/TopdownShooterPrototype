...
namespace Sonity.Internal {
    ...
    public class EditorTextModifier {
        ...
        public static string modifiersTooltip = 
            ...
            $"Modifiers are only updated once when starting the {nameof(NameOf.SoundEvent)}, not continuously" + NameOf.Tooltip;

        public static string addRemoveLabel = "Add/Remove";
        public static string addRemoveTooltip = $"Adds or removes a modifier." + NameOf.Tooltip;

        public static string resetLabel = "Reset";
        public static string resetTooltip = $"Resets all the values of the modifiers." + NameOf.Tooltip;

        public static string clearLabel = "Clear";
        public static string clearTooltip = $"Clears all the added modifiers." + NameOf.Tooltip;
        ...
        public static string pitchTooltip = $"Pitch offset in semitones." + NameOf.Tooltip;

        public static string delayLabel = "Delay";
        public static string delayTooltip = $"Increase the delay in seconds." + NameOf.Tooltip;

        public static string startPositionLabel = "Start Position";
        public static string startPositionTooltip = $"Sets the start position, 0 is the start, 1 is the end." + priority + NameOf.Tooltip;
        ...
        public static string distanceScaleNotEnabledTooltip = $"Distance is not enabled on the {nameof(NameOf.SoundContainer)} of the {nameof(NameOf.SoundEvent)}." + NameOf.Tooltip;

        public static string reverbZoneMixDecibelLabel = "Reverb Zone Mix dB";
        public static string reverbZoneMixDecibelTooltip = $"Reverb Zone Mix volume offset in decibel." + NameOf.Tooltip;
        ...
        public static string increase2DTooltip = 
            ...
            "\n" +
            $"Useful for first person sounds." + NameOf.Tooltip;

        public static string stereoPanLabel = "Stereo Pan";
        public static string stereoPanTooltip = 
            $"Stereo pan offset." + "\n" +
            "\n" +
            $"-1 is left, 0 is centered, +1 is right." + NameOf.Tooltip;

        public static string intensityLabel = "Intensity";
        public static string intensityTooltip = $"Multiplier of any used {nameof(SoundParameterIntensity)} parameter." + NameOf.Tooltip;

        public static string intensityNotEnabledText = "Intensity is not used";
        public static string intensityNotEnabledTooltip = $"Intensity is not enabled on the {nameof(NameOf.SoundContainer)} of the {nameof(NameOf.SoundEvent)}." + NameOf.Tooltip;
        ...
        public static string distortionIncreaseTooltip = 
            ...
            "\n" +
            $"Distortion needs to be enabled on the {nameof(NameOf.SoundContainer)} for this to have any effect." + NameOf.Tooltip;
        ...
        public static string distortionNotEnabledTooltip = $"Distortion is not enabled on the {nameof(NameOf.SoundContainer)} of the {nameof(NameOf.SoundEvent)}." + NameOf.Tooltip;
