...
namespace Sonity.Internal {
    ...
    public abstract class SoundMixEditorBase : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            if (GUILayout.Button(new GUIContent($"Sonity" + NameOf.Type + $" - {nameof(NameOf.SoundMix)}\n{mTarget.name}", EditorTextSoundMix.soundMixTooltip), guiStyleBoldCenter, GUILayout.ExpandWidth(true), GUILayout.Height(40))) {
