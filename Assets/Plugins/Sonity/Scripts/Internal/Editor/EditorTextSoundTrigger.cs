...
namespace Sonity.Internal {
    ...
    public class EditorTextSoundTrigger {
        ...
        public static string soundTriggerTooltip =
            ...
            "\n" +
            $"All {nameof(NameOf.SoundTrigger)} components are multi-object editable." + NameOf.Tooltip;

        public static string distanceRadiusLabel = "Distance Radius";
        public static string distanceRadiusTooltip = $"Distance of the {nameof(NameOf.SoundEvent)} (how far it should be heard)." + NameOf.Tooltip;
        ...
        public static string soundEventTooltip = $"The {nameof(NameOf.SoundEvent)} which is played" + NameOf.Tooltip;
        ...
        public static string triggerTagTooltip = $"If enabled, the {nameof(NameOf.SoundEvent)} will only play if the triggering object has a tag matching the selected tags." + NameOf.Tooltip;
        ...
        public static string collisionTagTooltip = $"If enabled, the {nameof(NameOf.SoundEvent)} will only play if the collision object has a tag matching the selected tags." + NameOf.Tooltip;
