...
namespace Sonity.Internal {
    ...
    public class EditorTextSoundManager {
        ...
        "\n" +
        $"Then set it to a negative value (like -50) so it loads before the code which you want to use Awake() to play sounds when starting your game." + NameOf.Tooltip;
        ...
        public static string resetSettingsTooltip = "Resets all settings." + NameOf.Tooltip;

        public static string resetAllLabel = "Reset All";
        public static string resetAllTooltip = "Resets settings and statistics." + NameOf.Tooltip;
        ...
        public static string disablePlayingSoundsTooltip = 
            ...
            "\n" +
            "Useful if you've for example implemented temp sounds and don't want everyone else to hear them." + NameOf.Tooltip;
        ...
        public static string globalSoundTagTooltip = 
            ...
            "\n" +
            $"{nameof(NameOf.SoundEvent)}s using global {nameof(NameOf.SoundTag)} are affected by this." + NameOf.Tooltip;
        ...
        public static string distanceScaleTooltip =
            ...
            "\n" +
            $"E.g. if Distance Scale is set to 100, a {nameof(NameOf.SoundEvent)} with the distance multiplier of 1 will be heard up to 100 Unity units away." + NameOf.Tooltip;
        ...
        public static string overrideListenerDistanceTooltip =
            ...
            "\n" +
            $"Try changing the Amount slider to find a nice balance between the different positions." + NameOf.Tooltip;
        ...
        public static string speedOfSoundEnabledTooltip = 
            $"Speed of sound is a delay based on the distance between the Audio Listener and a {nameof(NameOf.SoundEvent)}." + NameOf.Tooltip;
        ...
        public static string speedOfSoundScaleTooltip =
            ...
            "\n" +
            "1 equals 430 Unity units per second. Uses Time.realtimeSinceStartup." + NameOf.Tooltip;

        public static string debugWarningsLabel = "Debug Warnings";
        public static string debugWarningsTooltip =
            "Makes Sonity output Debug Warnings if anything is wrong." + NameOf.Tooltip;

        public static string debugInPlayModeLabel = "Debug In Play Mode";
        public static string debugInPlayModeTooltip =
            "Makes Sonity output Debug Warnings if anything is wrong in Play Mode." + NameOf.Tooltip;

        public static string guiWarningsLabel = "GUI Warnings";
        public static string guiWarningsTooltip =
            "Makes Sonity show GUI Warnings if anything is wrong in the editor." + NameOf.Tooltip;
        ...
        public static string dontDestoyOnLoadTooltip =
            ...
            "\n" +
            "For this to work the parent is set to null, which can move the objects." + NameOf.Tooltip;
        ...
        public static string voicePreloadTooltip = 
            ...
            "\n" +
            "Voice Limit cannot be lower than Voice Preload." + NameOf.Tooltip;
        ...
        public static string audioSettingsRealAndVirtualVoicesTooltip =
            ...
            "\"Edit\" > \"Project Settings\" > \"Audio\"" + NameOf.Tooltip;
        ...
        public static string voiceStopTimeTooltip =
            ...
            "\n" +
            "But having a lot of voices enabled which aren't used is also not good for performance, so don't set this value too high." + NameOf.Tooltip;
        ...
        public static string voiceEffectLimitTooltip =
            ...
            "\n" +
            "Try setting the buffer size to \"Best Performance\" in \"Edit\" > \"Project Settings\" > \"Audio\" if you want to run more Voice Effects." + NameOf.Tooltip;
        ...
        public static string voiceDebugSoundEventsLiveTooltip =
            ...
            "\n" +
            $"Useful for debugging when you want to see what is playing and where." + NameOf.Tooltip;
        ...
        public static string debugSoundEventsInSceneViewEnabledTooltip = 
            ...
            "\n" +
            $"Doesn't work in Unity versions older than 2019.1." + NameOf.Tooltip;
        ...
        public static string debugSoundEventsInGameViewEnabledTooltip = 
            ...
            "\n" +
            $"Only applied in the Unity editor." + NameOf.Tooltip;
        ...
        public static string debugSoundEventsVolumeToAlphaTooltip = 
            ...
            "\n" +
            $"E.g lower volumes will be more transparent." + NameOf.Tooltip;
        ...
        public static string debugSoundEventsLifetimeToAlphaTooltip =
            $"How much the lifetime of the {nameof(NameOf.SoundEvent)} will affect the transparency of the text." + NameOf.Tooltip;
        ...
        public static string debugSoundEventsColorStartTooltip = "The color the text should have when it starts playing." + NameOf.Tooltip;

        public static string debugSoundEventsColorFadeToLabel = "Lifetime Fade Color";
        public static string debugSoundEventsColorEndTooltip = "Which color the text should fade to over the lifetime." + NameOf.Tooltip;

        public static string debugSoundEventsColorOutlineLabel = "Outline Color";
        public static string debugSoundEventsColorOutlineTooltip = "The color of the text outline." + NameOf.Tooltip;

        // Statistics
        public static string statisticsExpandLabel = "Global Statistics";
        public static string statisticsExpandTooltip = "Statistics of Sonity." + NameOf.Tooltip;

        public static string statisticsSoundEventsLabel = $"{nameof(NameOf.SoundEvent)}s";
        public static string statisticsSoundEventsTooltip = $"Statistics of {nameof(NameOf.SoundEvent)}s." + NameOf.Tooltip;

        public static string statisticsSoundEventsCreatedLabel = "Created";
        public static string statisticsSoundEventsCreatedTooltip = $"The number of instantiated {nameof(NameOf.SoundEvent)}s." + NameOf.Tooltip;

        public static string statisticsSoundEventsActiveLabel = "Active";
        public static string statisticsSoundEventsActiveTooltip = $"The number of active {nameof(NameOf.SoundEvent)}s." + NameOf.Tooltip;

        public static string statisticsSoundEventsDisabledLabel = "Disabled";
        public static string statisticsSoundEventsDisabledTooltip = $"The number of unused and disabled {nameof(NameOf.SoundEvent)}s." + NameOf.Tooltip;

        public static string statisticsVoicesLabel = "Voices";
        public static string statisticsVoicesTooltip = "Statistics of Voices." + NameOf.Tooltip;

        public static string statisticsVoicesPlayedLabel = "Played";
        public static string statisticsVoicesPlayedTooltip = "The number of played Voices since start." + NameOf.Tooltip;

        public static string statisticsMaxSimultaneousVoicesLabel = "Max Simultaneous";
        public static string statisticsMaxSimultaneousVoicesTooltip = "The maximum number of simultaneously playing Voices since start." + NameOf.Tooltip;

        public static string statisticsVoicesStolenLabel = "Stolen";
        public static string statisticsVoicesStolenTooltip = "The number of stolen Voices since start." + NameOf.Tooltip;

        public static string statisticsVoicesCreatedLabel = "Created";
        public static string statisticsVoicesCreatedTooltip = "The number of Voices in the pool." + NameOf.Tooltip;

        public static string statisticsVoicesActiveLabel = "Active";
        public static string statisticsVoicesActiveTooltip = "The number of Voices playing audio." + NameOf.Tooltip;

        public static string statisticsVoicesInactiveLabel = "Inactive";
        public static string statisticsVoicesInactiveTooltip = "The number of inactive Voices in the pool." + NameOf.Tooltip;

        public static string statisticsVoicesPausedLabel = "Paused";
        public static string statisticsVoicesPausedTooltip = "The number of paused Voices in the pool." + NameOf.Tooltip;

        public static string statisticsVoicesStoppedLabel = "Stopped";
        public static string statisticsVoicesStoppedTooltip = "The number of stopped Voices in the pool." + NameOf.Tooltip;
        ...
        public static string statisticsVoiceEffectsTooltip = 
            ...
            "\n" +
            "A Voice with any combination of waveshaper/lowpass/highpass counts as one Voice Effect." + NameOf.Tooltip;

        public static string statisticsVoiceEffectsActiveLabel = "Active";
        public static string statisticsVoiceEffectsActiveTooltip = "The number of active Voice Effects." + NameOf.Tooltip;

        public static string statisticsVoiceEffectsAvailableLabel = "Available";
        public static string statisticsVoiceEffectsAvailableTooltip = "How many Voice Effects are available." + NameOf.Tooltip;
        ...
        public static string statisticsSoundEventInstancesTooltip =
            ...
            "\n" +
            "Available in Playmode." + NameOf.Tooltip;
        ...
        public static string statisticsSortingTooltip =
            ...
            "\n" +
            "Time" + "\n" +
            "Sorts by last time played." + NameOf.Tooltip;
        ...
        public static string statisticsShowTooltip = 
            ...
            "\n" +
            "Show Volume" + "\n" +
            "The current average volume." + NameOf.Tooltip;

        public static string statisticsResetLabel = "Reset";
        public static string statisticsResetTooltip = "Resets statistics." + NameOf.Tooltip;
    }
}
#endif