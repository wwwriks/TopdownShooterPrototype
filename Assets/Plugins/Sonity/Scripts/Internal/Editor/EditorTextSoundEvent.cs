...
namespace Sonity.Internal {
    ...
    public class EditorTextSoundEvent {
        ...
        "\n" +
        $"All {nameof(NameOf.SoundEvent)}s are multi-object editable." + NameOf.Tooltip;

        // Reset
        public static string resetSettingsLabel = $"Reset Options";
        public static string resetSettingsTooltip = $"Resets all but the {nameof(NameOf.SoundContainer)}s." + NameOf.Tooltip;

        public static string resetAllLabel = $"Reset All";
        public static string resetAllTooltip = $"Resets everything." + NameOf.Tooltip;
        ...
        public static string findReferencesSelectAllTooltip = $"Selects all the assets with references to the {nameof(NameOf.SoundEvent)}." + NameOf.Tooltip;
        ...
        public static string muteEnableTooltip = 
            ...
            $"Only affects the Unity Editor." + NameOf.Tooltip;
        ...
        public static string disableEnableTooltip =
            ...
            "\n" +
            $"It is also disabled when building the project." + NameOf.Tooltip;
        ...
        public static string findSoundContainersTooltip =
            ...
            "\n" +
            $"If no matching {nameof(NameOf.SoundContainer)}s are found, it will try and remove one character at the end of the name at a time until it finds a hit." + NameOf.Tooltip;
        ...
        public static string timelineExpandTooltip =
            ...
            "\n" +
            $"Focus on items: F" + NameOf.Tooltip;

        public static string timelineResetLabel = "Reset";
        public static string timelineResetTooltip = "Reset all the Timeline settings." + NameOf.Tooltip;
        ...
        public static string polyphonyModeTooltip =
            ...
            "\n" +
            $"Tip: If you want to limit the polyphony per owner and globally at the same time, you can use {nameof(NameOf.SoundPolyGroup)}s." + NameOf.Tooltip;
        ...
        public static string soundMixTooltip = $"{nameof(NameOf.SoundMix)} enables hierarchical control of for example volume." + NameOf.Tooltip;

        public static string soundPolyGroupLabel = $"{nameof(NameOf.SoundPolyGroup)}";
        public static string soundPolyGroupTooltip = $"{nameof(NameOf.SoundPolyGroup)} gives polyphony control grouped over different {nameof(NameOf.SoundEvent)} types." + NameOf.Tooltip;
        ...
        public static string soundPolyGroupPriorityTooltip = 
            ...
            "\n" +
            $"If \"Skip Lower Priority\" is enabled on the {nameof(NameOf.SoundPolyGroup)} this will determine if this {nameof(NameOf.SoundEvent)} will play or not when the Polyphony Limit is reached." + NameOf.Tooltip;
        ...
        public static string cooldownTimeTooltip = 
            ...
            "\n" +
            $"Calculated using Time.realtimeSinceStartup." + NameOf.Tooltip;

        public static string probabilityLabel = $"Probability %";
        public static string probabilityTooltip = $"The probability that this {nameof(NameOf.SoundEvent)} should play." + NameOf.Tooltip;
        ...
        public static string passParametersTooltip = 
            ...
            "\n" +
            $"E.g SoundTag, TriggerOnPlay, TriggerOnStop, TriggerOnTail." + NameOf.Tooltip;

        // Intensity Scaling
        public static string intensityFoldoutLabel = "Intensity";
        public static string intensityFoldoutTooltip =
            $"Settings for how any used {nameof(SoundParameterIntensity)} is scaled before it is applied to any enabled intensity options e.g Volume, Pitch etc." + NameOf.Tooltip;

        public static string intensityAddLabel = "Add";
        public static string intensityAddTooltip = $"Adds to the {nameof(SoundParameterIntensity)}." + NameOf.Tooltip;

        public static string intensityMultiplierLabel = "Multiplier";
        public static string intensityMultiplierTooltip = $"Multiplier of the {nameof(SoundParameterIntensity)}." + NameOf.Tooltip;
        ...
        public static string intensitySeekTimeTooltip =
            ...
            "\n" +
            $"Uses Time.realtimeSinceStartup." + NameOf.Tooltip;
        ...
        public static string intensityThresholdEnableTooltip =
            $"If this {nameof(NameOf.SoundEvent)} is played with a {nameof(SoundParameterIntensity)} and it is under the threshold when starting it won't be played." + NameOf.Tooltip;

        public static string intensityThresholdLabel = "Threshold";
        public static string intensityThresholdTooltip = "The threshold limit after scaling the intensity value." + NameOf.Tooltip;

        public static string intensityDebugLabel = "Intensity Record";
        public static string intensityDebugTooltip =
            $"If enabled it will record all {nameof(SoundParameterIntensity)} used when playing this {nameof(NameOf.SoundEvent)}." + NameOf.Tooltip;
        ...
        public static string intensityDebugScaleValuesTooltip =
            ...
            "\n" +
            "Then sets Intensity Multiply so that the highest value is 1." + NameOf.Tooltip;

        public static string intensityDebugResolutionLabel = "Debug Resolution";
        public static string intensityDebugResolutionTooltip = "The resolution of the displayed values." + NameOf.Tooltip;

        // Intensity Settings Warnings
        public static string intensityDebugRecordLabel = "Record available in Play Mode";
        public static string intensityDebugRecordTooltip = "To record intensity debug data, play the game with Intensity Record enabled." + NameOf.Tooltip;
        ...
        public static string intensityValuesRecordedTooltip =
            ...
            "\n" +
            "If so, clear the logged values to speed it up." + NameOf.Tooltip;
        ...
        public static string triggerOnWhichToPlayTooltip =
            ...
            "\n" +
            $"The randomizer uses a pseudo random function remembering which {nameof(NameOf.SoundEvent)}s it last played to avoid repetition." + NameOf.Tooltip;

        public static string triggerOnPlayLabel = $"Trigger On Play";
        public static string triggerOnPlayTooltip =
            $"Triggers another {nameof(NameOf.SoundEvent)} when this {nameof(NameOf.SoundEvent)} is played." + NameOf.Tooltip;

        public static string triggerOnStopLabel = $"Trigger On Stop";
        public static string triggerOnStopTooltip =
            $"Triggers another {nameof(NameOf.SoundEvent)} when this {nameof(NameOf.SoundEvent)} is stopped." + NameOf.Tooltip;
        ...
        public static string triggerOnTailTooltip = 
            ...
            "\n" +
            $"If the trigger timing is not tight enough, try setting the AudioClip \"Compression Format\" to PCM or ADPCM (Vorbis is less accurate)." + NameOf.Tooltip;
        ...
        public static string triggerOnTailTailLengthTooltip =
            ...
            "\n" +
            $"This is because double the speed with half the duration and vice versa." + NameOf.Tooltip;

        public static string triggerOnTailSetTailLengthFromBpmLabel = $"Set Tail Length from BPM & Beats";
        public static string triggerOnTailSetTailLengthFromBpmTooltip = $"Calculates the Tail Length from the BPM and the Beats settings." + NameOf.Tooltip;

        public static string triggerOnTailBpmLabel = $"BPM";
        public static string triggerOnTailBpmTooltip = $"Beats per minute." + NameOf.Tooltip;

        public static string triggerOnTailTailLengthInBeatsLabel = $"Beats";
        public static string triggerOnTailTailLengthInBeatsTooltip = $"How long the tail is in beats." + NameOf.Tooltip;
        ...
        public static string soundTagEnableTooltip = 
            ...
            "\n" +
            $"The {nameof(NameOf.SoundTag)} won't be passed to the {nameof(NameOf.SoundEvent)}s of the {nameof(NameOf.SoundTag)} in order to avoid infinite repetitions." + NameOf.Tooltip;
        ...
        public static string soundTagModeTooltip =
            ...
            "\n" +
            $"If global {nameof(NameOf.SoundTag)} is selected you need to set the {nameof(NameOf.SoundTag)} on the {nameof(NameOf.SoundManager)}." + NameOf.Tooltip;

        public static string soundTagLabel = $"{nameof(NameOf.SoundTag)}";
        public static string soundTagTooltip = $"If this {nameof(NameOf.SoundTag)} is selected the {nameof(NameOf.SoundEvent)}s below will be played." + NameOf.Tooltip;
    }
}
#endif