...
namespace Sonity.Internal {
    ...
    public static class EditorTextPreview {
        ...
        public static string soundContainerPlayTooltip =
            ...
            "\n" +
            $"The default shortcut is Ctrl+Q." + NameOf.Tooltip;
        ...
        public static string stopTooltip = 
            ...
            "\n" +
            $"The default shortcut is Ctrl+W." + NameOf.Tooltip;

        public static string resetLabel = "Reset";
        public static string resetTooltip = "Resets the preview settings." + NameOf.Tooltip;

        public static string intensityLabel = "Intensity";
        public static string intensityTooltip = $"Controls the intensity value of the played {nameof(NameOf.SoundContainer)}s." + NameOf.Tooltip;

        public static string audioMixerGroupLabel = "AudioMixerGroup";
        public static string audioMixerGroupTooltip = $"Only used for preview." + NameOf.Tooltip;
