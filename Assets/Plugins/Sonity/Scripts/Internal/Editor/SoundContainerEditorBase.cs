...
namespace Sonity.Internal {
    ...
    public abstract class SoundContainerEditorBase : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            if (GUILayout.Button(new GUIContent($"Sonity" + NameOf.Type + $" - {nameof(NameOf.SoundContainer)}\n{mTarget.name}", EditorTextSoundContainer.soundContainerTooltip), guiStyleBoldCenter, GUILayout.ExpandWidth(true), GUILayout.Height(40))) {
            ...
            try {
                ...
                if (preset == PresetType.SFX3D) {
                    ...
                    for (int i = 0; i < mTargets.Length; i++) {
                        ...
                        if (mTargets[i].name.ToLower().Contains("loop")) {
