...
namespace Sonity.Internal {
    ...
    public class EditorTextSoundContainer {
        ...
        "\n" +
        $"All {nameof(NameOf.SoundContainer)}s are multi-object editable." + NameOf.Tooltip;
        ...
        public static string presetsTooltip =
            ...
            "\n" +
            "Automatic Looping:" + "\n" +
            $"If the name of the selected {nameof(NameOf.SoundContainer)}s contains “loop” then it will automatically set it to loop." + "\n" +
            "\n" +
            ...
            "Soft + Hard = 2 layers" + NameOf.Tooltip;
        ...
        public static string updateAudioClipsTooltip =
            ...
            "\n" +
            $"If no matching {nameof(AudioClip)}s are found, it will try and remove one character at the end of the name at a time until it finds a hit." + NameOf.Tooltip;

        public static string findReferencesLabel = $"Find References";
        public static string findReferencesTooltip = $"Finds all the references to the {nameof(NameOf.SoundEvent)}." + NameOf.Tooltip;

        public static string findReferencesSelectAllLabel = $"Select All";
        public static string findReferencesSelectAllTooltip = $"Selects all the assets with references to the {nameof(NameOf.SoundContainer)}." + NameOf.Tooltip;

        public static string findReferencesClearLabel = $"Clear";
        public static string findReferencesClearTooltip = $"Removes all the found references." + NameOf.Tooltip;
        ...
        public static string audioMixerGroupTooltip =
            ...
            "\n" +
            $"If you just want to control volume hierarchically look at {nameof(NameOf.SoundMix)} assets for a high performance solution." + NameOf.Tooltip;

        public static string enableDistanceLabel = "Enable Distance";
        public static string enableDistanceTooltip = $"Otherwise the {nameof(NameOf.SoundContainer)} will not be affected by distance (disable for music etc)." + NameOf.Tooltip;

        public static string distanceScaleLabel = "Distance Scale";
        public static string distanceScaleTooltip = 
            $"Range scale multiplier." +
            "\n" +
            $"It is multiplied by the Distance Scale of the {nameof(NameOf.SoundManager)}." + NameOf.Tooltip;

        public static string loopLabel = "Loop";
        public static string loopTooltip =
            $"Makes the sound loop." + "\n" +
            "\n" +
            "If you use \"Create Assets from Selection\" and the AudioClip contains the word \"Loop\" it will automatically be enabled." + NameOf.Tooltip;

        public static string followPositionLabel = "Follow Position";
        public static string followPositionTooltip = $"If the {nameof(NameOf.SoundContainer)} should follow the given Transform position." + NameOf.Tooltip;
        ...
        public static string stopIfTransformIsNullTooltip =
            ...
            "\n" +
            "Useful safety precaution for loops." + NameOf.Tooltip;

        public static string virtualizeLabel = "Virtualize";
        public static string virtualizeTooltip = "" + NameOf.Tooltip;
        ...
        public static string randomStartPositionTooltip = 
            ...
            "\n" +
            "Useful for loops." + NameOf.Tooltip;

        public static string randomStartPositionMinMaxLabel = "Random Range";
        public static string randomStartPositionMinMaxTooltip = "Min/max range within the sound can start at." + NameOf.Tooltip;

        public static string startPositionLabel = "Start Position";
        public static string startPositionTooltip = "0 is the start and 1 is the end." + NameOf.Tooltip;
        ...
        public static string reverseTooltip =
            ...
            "\n" +
            $"Reverse is only supported for AudioClips which are stored in an uncompressed format or will be decompressed at load time." + NameOf.Tooltip;
        ...
        public static string lockAxisEnableTooltip = 
            ...
            "\n" +
            "Useful for 2D games if you want to lock the sound to a position along an axis." + NameOf.Tooltip;

        public static string lockAxisLabel = $"Axis";
        public static string lockAxisTooltip = "The axis to lock." + NameOf.Tooltip;

        public static string lockAxisPositionLabel = $"Position";
        public static string lockAxisPositionTooltip = "The position to set the locked axis to." + NameOf.Tooltip;
        ...
        public static string preventEndClicksTooltip =
            ...
            "\n" +
            $"Tip: If you still experience sporadic clicks, try changing the Load Type of the AudioClips to e.g. \"Compressed In Memory\", it might help." + NameOf.Tooltip;
        ...
        public static string priorityTooltip =
            ...
            "\n" +
            "It's multiplied with the volume of the Voice when evaluating final priority." + NameOf.Tooltip;

        public static string neverStealVoiceLabel = "Never Steal Voice";
        public static string neverStealVoiceTooltip =
            $"The {nameof(NameOf.SoundManager)} will never steal this Voice if the Voice Limit is reached (use on music etc)." + NameOf.Tooltip;
        ...
        public static string neverStealVoiceEffectsTooltip =
            $"The {nameof(NameOf.SoundManager)} will never steal the Voice Effects on this Voice if the Voice Effect Limit is reached (use on music etc)." + NameOf.Tooltip;
        ...
        public static string playOrderTooltip =
            ...
            "\n" +
            $"Local Random" + "\n" +
            $"Same as global random except its per {nameof(NameOf.SoundEvent)} owner." + NameOf.Tooltip;


        public static string dopplerAmountLabel = "Doppler Amount";
        public static string dopplerAmountTooltip =
            $"How much the pitch of the sound is changed by the relative velocity between the {nameof(AudioListener)} and the {nameof(AudioSource)}." + NameOf.Tooltip;

        public static string bypassReverbZonesLabel = "Bypass Reverb Zones";
        public static string bypassReverbZonesTooltip = "Bypasses any reverb zones" + NameOf.Tooltip;
        ...
        public static string bypassVoiceEffectsTooltip = 
            ...
            "\n" +
            "Voice effects are automatically bypassed if you don't have distortion/lowpass/highpass enabled." + NameOf.Tooltip;

        public static string bypassListenerEffectsLabel = "Bypass Listener Effects";
        public static string bypassListenerEffectsTooltip = "Bypasses any effects on the listener" + NameOf.Tooltip;

        // Volume
        public static string volumeLabel = "Volume dB";
        public static string volumeTooltip = "The volume in dB." + NameOf.Tooltip;
        ...
        public static string volumeRelativeLowerTooltip = 
            ...
            "\n" +
            $"If multiple {nameof(NameOf.SoundContainer)}s are selected it will show the lowest volume." + NameOf.Tooltip;
        ...
        public static string volumeRelativeIncreaseTooltip =
            ...
            "\n" +
            $"If multiple {nameof(NameOf.SoundContainer)}s are selected it will show the highest volume." + NameOf.Tooltip;

        public static string volumeRandomLabel = "Random";
        public static string volumeRandomTooltip = "Toggles random volume." + NameOf.Tooltip;

        public static string volumeRandomRangeLabel = "Range dB";
        public static string volumeRandomRangeTooltip = "Amount of random volume to lower by in decibel." + NameOf.Tooltip;

        public static string volumeDistanceLabel = "Distance";
        public static string volumeDistanceTooltip = $"Changes the sound over distance." + NameOf.Tooltip;

        public static string volumeDistanceRolloffLabel = "Rolloff";
        public static string volumeDistanceRolloffTooltip = "The power of the rolloff.\n\n0 is linear." + NameOf.Tooltip;

        public static string volumeDistanceCurveLabel = "Curve";
        public static string volumeDistanceCurveTooltip = "Curve of the volume over distance.\n\nFrom 0 (close) to 1 (distant)." + NameOf.Tooltip;
        ...
        public static string volumeDistanceCrossfadeEnabledTooltip =
            ...
            "\n" +
            $"Then you’d set “This Is” of close to 1, distant to 2, and far to 3." + NameOf.Tooltip;
        ...
        public static string volumeDistanceCrossfadeLayersTooltip = 
            ...
            "\n" +
            "You must have at least 2 layers." + NameOf.Tooltip;
        ...
        public static string volumeDistanceCrossfadeThisIsTooltip = 
            ...
            "\n" +
            $"Lower numbers are closer and higher are more distant." + NameOf.Tooltip;
        ...
        public static string volumeDistanceCrossfadeCurveTooltip = 
            ...
            "\n" +
            "Standard is from 0 (close) to 1 (distant)." + NameOf.Tooltip;

        public static string volumeIntensityEnableLabel = "Intensity";
        public static string volumeIntensityEnableTooltip = 
            $"Changes the sound over intensity.\n\nUse on for example physics sounds where you pass the velocity with a {nameof(SoundParameterIntensity)}." + NameOf.Tooltip;
        ...
        public static string volumeIntensityStrengthTooltip = "How much effect the intensity should have." + NameOf.Tooltip;

        public static string volumeIntensityCurveLabel = "Curve";
        public static string volumeIntensityCurveTooltip = "Curve of the volume over intensity.\n\nFrom 0 (soft) to 1 (hard)." + NameOf.Tooltip;
        ...
        public static string volumeIntensityCrossfadeEnabledTooltip =
            ...
            $"You’d set the “Layers” setting to 3 for all the {nameof(NameOf.SoundContainer)}s." +
            "\n" +
            $"Then you’d set “This Is” of hard to 3, medium to 2 and soft to 1." + NameOf.Tooltip;
        ...
        public static string volumeIntensityCrossfadeThisIsTooltip = 
            ...
            $"Set up with other {nameof(NameOf.SoundContainer)}s for the other layers." + "\n" +
            "\n" +
            $"Higher numbers are harder and lower numbers are softer." + NameOf.Tooltip;
        ...
        public static string pitchTooltip = $"The pitch in semitones.\n\nRange -24 to +24." + NameOf.Tooltip;

        public static string pitchRandomLabel = "Random";
        public static string pitchRandomTooltip = "Toggle random pitch." + NameOf.Tooltip;

        public static string pitchRandomRangeLabel = "Range st";
        public static string pitchRandomRangeTooltip = "Amount of random pitch variation in semitones (bipolar)." + NameOf.Tooltip;
        ...
        public static string spatialBlendBaseTooltip = "Amount of spatial blend.\n\n0 is 2D and 1 is 3D." + NameOf.Tooltip;

        public static string spatialBlendDistanceLabel = "Distance";
        public static string spatialBlendDistanceTooltip = $"Changes the sound over distance." + NameOf.Tooltip;
        ...
        public static string spatialBlendDistance3DIncreaseTooltip = "Increase the amount of spatial blend." + NameOf.Tooltip;
        ...
        public static string spatialBlendIntensityStrengthTooltip = "How much effect the intensity should have." + NameOf.Tooltip;
        ...
        public static string spatialSpreadBaseTooltip = 
            ...
            "\n" +
            "Only the 3D part of the sound is affected by the spatial spread." + NameOf.Tooltip;

        public static string spatialSpreadDistanceLabel = "Distance";
        public static string spatialSpreadDistanceTooltip = $"Changes the sound over distance." + NameOf.Tooltip;
        ...
        public static string spatialSpreadIntensityStrengthTooltip = "How much effect the intensity should have." + NameOf.Tooltip;
        ...
        public static string stereoPanOffsetTooltip =
            ...
            "\n" +
            "Only the 2D part of the sound is affected by the stereo pan." + NameOf.Tooltip;
        ...
        public static string stereoPanAngleToSteroPanStrengthTooltip = "The amount of angle to stereo pan." + NameOf.Tooltip;
        ...
        public static string reverbZoneMixDecibelTooltip = "The amount of reverb zone send in decibel." + NameOf.Tooltip;

        public static string reverbZoneMixDistanceLabel = "Distance";
        public static string reverbZoneMixDistanceTooltip = $"Changes the sound over distance." + NameOf.Tooltip;
        ...
        public static string reverbZoneMixDistanceIncreaseTooltip = "Increase the amount of reverb mix." + NameOf.Tooltip;
        ...
        public static string reverbZoneMixIntensityStrengthTooltip = "How much effect the intensity should have." + NameOf.Tooltip;
        ...
        public static string distortionEnableTooltip = 
            ...
            "\n" +
            "DSP effects are not available in WebGL." + NameOf.Tooltip;

        public static string distortionAmountLabel = "Amount";
        public static string distortionAmountTooltip =
            "The amount of distortion." + "\n" +
            "\n" +
            "0 is clean, 1 is distorted." + NameOf.Tooltip;

        public static string distortionDistanceLabel = "Distance";
        public static string distortionDistanceTooltip = $"Changes the sound over distance." + NameOf.Tooltip;
        ...
        public static string distortionDistanceCurveTooltip =  
            ...
            "\n" +
            "1 (close) is distorted, 0 (far) is clean." + NameOf.Tooltip;
        ...
        public static string distortionIntensityStrengthTooltip = "How much effect the intensity should have." + NameOf.Tooltip;
        ...
        public static string distortionIntensityCurveTooltip = 
            ...
            "\n" +
            "0 (soft) is clean, 1 (hard) is distortion." + NameOf.Tooltip;
        ...
        public static string lowpassFrequencyTooltip = "The cutoff frequency of the lowpass filter in Hz." + NameOf.Tooltip;

        public static string lowpassAmountLabel = "Amount dB";
        public static string lowpassAmountTooltip = "The base lowpass slope in dB per octave." + NameOf.Tooltip;

        public static string lowpassDistanceLabel = "Distance";
        public static string lowpassDistanceTooltip = $"Changes the sound over distance." + NameOf.Tooltip;
        ...
        public static string lowpassIntensityFrequencyStrengthTooltip =
            "How much effect the intensity should have." + NameOf.Tooltip;
        ...
        public static string lowpassIntensityAmountStrengthTooltip = "How much effect the intensity should have." + NameOf.Tooltip;
        ...
        public static string highpassFrequencyTooltip = "The cutoff frequency of the highpass filter in Hz." + NameOf.Tooltip;

        public static string highpassAmountLabel = "Amount dB";
        public static string highpassAmountTooltip = "The base highpass slope in dB per octave." + NameOf.Tooltip;

        public static string highpassDistanceLabel = "Distance";
        public static string highpassDistanceTooltip = $"Changes the sound over distance." + NameOf.Tooltip;
        ...
        public static string highpassIntensityFrequencyStrengthTooltip = "How much effect the intensity should have." + NameOf.Tooltip;
        ...
        public static string highpassIntensityAmountStrengthTooltip = "How much effect the intensity should have." + NameOf.Tooltip;
        ...
        public static string showPreviewCurvesTooltip = "Toggles showing the preview curves." + NameOf.Tooltip;

        public static string resetSettingsLabel = "Reset Options";
        public static string resetSettingsTooltip = $"Resets the {nameof(NameOf.SoundContainer)} to the default options." + NameOf.Tooltip;

        public static string resetAllLabel = "Reset All";
        public static string resetAllTooltip = $"Resets the {nameof(NameOf.SoundContainer)} and the {nameof(AudioClip)}s to the default settings." + NameOf.Tooltip;
    }
}
#endif