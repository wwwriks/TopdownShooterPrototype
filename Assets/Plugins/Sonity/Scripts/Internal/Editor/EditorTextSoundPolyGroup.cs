...
namespace Sonity.Internal {
    ...
    public class EditorTextSoundPolyGroup {
        ...
        public static string soundPolyGroupTooltip =
            ...
            "\n" +
            $"All {nameof(NameOf.SoundPolyGroup)} objects are multi-object editable." + NameOf.Tooltip;

        public static string polyphonyLimitLabel = "Polyphony Limit";
        public static string polyphonyLimitTooltip = $"The maximum number of {nameof(NameOf.SoundEvent)}s which can be played at the same time in this {nameof(NameOf.SoundPolyGroup)}." + NameOf.Tooltip;
    }
}
#endif