...
namespace Sonity.Internal {
    ...
    public abstract class SoundManagerEditorBase : Editor {
        ...
        private void FindProperties() {
            ...
            internals = serializedObject.FindProperty(nameof(SoundManagerBase.Internals).ToLower());
        ...
        public override void OnInspectorGUI() {
            ...
            EditorGuiFunction.DrawLayoutObjectTitle($"Sonity - {nameof(NameOf.SoundManager)}", EditorTextSoundManager.soundManagerTooltip);
